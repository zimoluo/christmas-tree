...
export default function ChristmasTreeInfo() {
  ...
  return (
    <button
      className="w-7 h-7 text-center font-serif font-bold rounded-full bg-light border-reflect bg-opacity-80 text-xl shadow-md select-none group flex items-center justify-center"
      onClick={() => {
        appendPopUp({
